...
[Check this is actually the same staircase diagram that Hatcher is talking about - I think it is just modulo some reindexing because the bigrading is a bit weird in the Adams spectral sequence.]
...
\begin{itemize}
\item When am I supposed to be using reduced vs unreduced (co)homology? 

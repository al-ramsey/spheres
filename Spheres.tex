...
Let \(X\) be a connective spectrum of finite type. Then \(\Ext_{\A}^{*,*}(H^*(X), \bb{F}_2)\) is an \((\Ext_{\A}^{*,*}(\bb{F}_2, \bb{F}_2))\)-module, with action given by the Yoneda product \(\Ext_{\A}^{*,*}(\bb{F}_2, \bb{F}_2)\otimes \Ext_{\A}^{*,*}(H^*(X), \bb{F}_2)\to \Ext_{\A}^{*,*}(H^*(X), \bb{F}_2)\) of \ref{2505042248yeahiknow}. 

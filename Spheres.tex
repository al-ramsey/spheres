...
\item \textcolour{violet}{Thus(!!) \(d_2(\overline{\overline{h_0^2h_3}})=i(h_0d_0)\).} [If we accept the claims that \(h_2\overline{\overline{h_0^2h_3}}=i(f_0)\) and \(i(h_0^2e_0)\neq 0\), and further suppose that \(i\) and \(d_2\) commute, we have \(h_2d_2(\overline{\overline{h_0^2h_3}})= d_2(h_2\overline{\overline{h_0^2h_3}})=

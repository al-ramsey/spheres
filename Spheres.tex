...
Y \arrow[r, "\id"] \arrow[d, swap, "", dashrightarrow]  & Y \arrow[r, "", hookrightarrow] \arrow[d, "f"] & CY \arrow[d, "h"] \arrow[r, "", hookrightarrow] & \Sigma Y \arrow[d, "", dashrightarrow] \arrow[r, "\id"] & \Sigma Y \arrow[d, "\Sigma f", dashrightarrow]\\ 
 ...
 \end{tikzcd}\] 
\textcolour{violet}{\autocite{hatcher5} says that ``we can then automatically fill in the next two vertical maps to make homotopy commutative squares''. Vaguely, I think this is because of some sort of naturality argument, which \autocite{hatcher} says is `evident' on p398. If we can, then...}
...
\begin{theorem}[{\autocite{spectra}, Prop 9.2.22}]

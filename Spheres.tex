...
\item \(Sq^i(\alpha)=\alpha^2\) if \(i=\abs{\alpha}\) and \(Sq^i(\alpha)=0\) if \(i> \abs{\alpha}\).
\item \(Sq^0=\id.\)
...
\autocite{ass}, \autocite{spectra}, \autocite{hatcher}
...
\autocite{stable_homotopy}, \autocite{cobordism}, \autocite{ass}, \autocite{spectra}

\section{The Adams spectral sequence}

\autocite{spectral_sequences}, \autocite{stable_homotopy}, \autocite{cobordism}

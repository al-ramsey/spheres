...
\printbibliography
\let\thefootnote\relax\footnotetext{Note: the TeX code used to generate the arrows in the long exact sequence on p28, and the arrows/axis labels in Figure \ref{2504201106}, was adapted from suggestions given at the links below (all last visited on 07/05/2025).\\

...
\usepackage{caption} % for making figure references point to the figure instead of the caption (why this is not the default is beyond me).
\usepackage[british]{babel} % corrects wrong date format in bibliography
...
\end{align*}
%looks sort of appalling, I'm sorry. 
...
\begin{proof}
We show the first two relations; the final two are obtained similarly. % but more difficult to typeset in tikz...

...
\draw [->] ([yshift=.75pt]{pic cs:51co}) -- ({pic cs:60ai});
...
\draw [->] ([yshift=.75pt]{pic cs:52eo}) -- ({pic cs:61fi});
...
\draw [->] ([yshift=.75pt]{pic cs:62fo}) -- ({pic cs:71ei});
...
\draw [->] ([yshift=.75pt]{pic cs:63do}) -- ({pic cs:72ei});
\draw [->] ([yshift=.75pt]{pic cs:63do}) -- ({pic cs:72fi});
\draw [->] ([yshift=.75pt]{pic cs:63eo}) -- ({pic cs:72gi});
\draw [->] ([yshift=.75pt]{pic cs:63eo}) -- ({pic cs:72di});
